...
public class HeaderConstant {
    ...
    public static String[] convertWorldDetailsToString(PropertyCount propertyCount, int i) {
        return new String[]{
                ...
                Objects.toString(propertyCount.getScreenshotOfBookingEngineUrl(), ""),
                Objects.toString(propertyCount.getBrandOfBookingEngineId(), ""),
                Objects.toString(propertyCount.getEHotelId(), ""),
